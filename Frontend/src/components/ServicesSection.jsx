  ...
  const services = [
    {
      id: 1,
      title: 'WEDDING',
      image: 'https://images.unsplash.com/photo-1519225421980-715cb0215aed?q=80&w=1170&auto=format&fit=crop',
      description: 'Searching for the best places for your event? Give us a try. Let our professionals help you find the best venue of your preferences.',
    },
    {
      id: 2,
    ...
    },
    {
      id: 4,
      title: 'RICE CEREMONY',
      image: 'https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?q=80&w=1144&auto=format&fit=crop',
      description: 'Capture every precious moment with our professional photography and videography services. We preserve your memories beautifully.',
    },
    {
      id: 5,
    ...
    },
    {
      ...
      description: 'Professional event planning for conferences, seminars, and corporate gatherings with meticulous attention to detail.',
    },
    {
      id: 7,
      title: 'ENGAGEMENT CEREMONY',
      image: 'https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=1170&auto=format&fit=crop',
      description: 'Create unforgettable engagement moments with our bespoke planning services and elegant decorations.',
    },
    {
      id: 8,
      title: 'BABY SHOWER',
      image: 'https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?q=80&w=1144&auto=format&fit=crop',
      description: 'Celebrate new beginnings with charming baby shower arrangements that create lasting memories.',
    },
    {
      id: 9,
      title: 'ANNIVERSARY PARTIES',
      image: 'https://images.unsplash.com/photo-1464207687429-7505649dae38?q=80&w=1173&auto=format&fit=crop',
      description: 'Mark your milestones with elegant anniversary celebrations designed just for you.',
    },
    {
      id: 10,
      title: 'THEME PARTIES',
      image: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?q=80&w=1170&auto=format&fit=crop',
      description: 'Bring your imagination to life with our creative themed party concepts and decorations.',
    },
    {
      id: 11,
      title: 'FESTIVAL CELEBRATIONS',
      image: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?q=80&w=1170&auto=format&fit=crop',
      description: 'Experience traditional and modern festival celebrations with cultural authenticity and style.',
    },
    {
      id: 12,
      title: 'OUTDOOR EVENTS',
      image: 'https://images.unsplash.com/photo-1478147427282-58a87a120781?q=80&w=1170&auto=format&fit=crop',
      description: 'Perfect outdoor event experiences with comprehensive planning for any weather condition.',
    }
  ];
    ...
    <>
      <style>{`
        ...
        .carousel-slide-active {
          animation: slideInCarousel 0.8s cubic-bezier(0.34, 1.56, 0.64, 1);
        }
      `}</style>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <button
              onClick={prevSlide}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-40 bg-white/95 hover:bg-white text-[#C41E3A] p-4 rounded-full shadow-2xl hover:shadow-[0_0_30px_rgba(196,30,58,0.3)] transition-all duration-300 hover:scale-110 group backdrop-blur-sm"
            ...
            <button
              onClick={nextSlide}
              className="absolute right-0 top-1/2 -translate-y-1/2 z-40 bg-white/95 hover:bg-white text-[#C41E3A] p-4 rounded-full shadow-2xl hover:shadow-[0_0_30px_rgba(196,30,58,0.3)] transition-all duration-300 hover:scale-110 group backdrop-blur-sm"
            ...
            <div className="overflow-hidden px-12 sm:px-16 lg:px-20">
              ...
              >
                {services.map((service, index) => (
                  <div
                    key={service.id}
                    className={`min-w-full px-4 ${index === currentSlide ? 'carousel-slide-active' : ''}`}
                  >
                    <div
                      className="envelope-container max-w-md mx-auto"
                      onMouseEnter={() => setHoveredCard(service.id)}
                      onMouseLeave={() => setHoveredCard(null)}
                    >
            ...
            <div className="text-center mt-8">
              <div className="inline-flex items-center gap-3 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg border border-gray-200">
                <div className="text-[#C41E3A] font-bold text-2xl" style={{ fontFamily: "'Playfair Display', serif" }}>
                  {String(currentSlide + 1).padStart(2, '0')}
                </div>
                <div className="h-8 w-0.5 bg-gray-300" />
                <div className="text-gray-400 font-bold text-xl" style={{ fontFamily: "'Playfair Display', serif" }}>
            ...
            <div className="flex justify-center items-center gap-2 mt-6 flex-wrap px-4">
              {services.map((_, index) => (
                <button
                  ...
                  className={`indicator-dot rounded-full transition-all duration-400 ${
                    index === currentSlide 
                      ? 'w-10 h-2.5 bg-[#C41E3A] shadow-lg' 
                      : 'w-2.5 h-2.5 bg-gray-300 hover:bg-[#C41E3A]/50'
                  }`}
            ...
            <div className="flex justify-center items-center gap-2 mt-6">
              <button
                ...
                className="text-gray-500 hover:text-[#C41E3A] transition-colors text-sm flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-white/50"
